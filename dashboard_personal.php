<?php
session_start();
// Redirige si el usuario no ha iniciado sesión o no es de tipo 'personal'
if (!isset($_SESSION["usuario_id"]) || $_SESSION["tipo"] != "personal") {
...
$net_income = $total_income - $total_expenses; // Calcula la ganancia neta
$savings_rate = ($total_income > 0) ? (($net_income / $total_income) * 100) : 0; // Calcula el porcentaje de ahorro
...
<head>
    <meta charset="UTF-8">
    <title>Gestor Personal de Gastos</title>
    ...
    <div class="main-content">
        ...
        <div class="card summary-card">
            ...
            <div class="summary-grid">
                ...
                <div class="summary-item"><h3 id="netIncome" class="<?php echo ($net_income < 0) ? 'negative' : 'positive'; ?>">$<?php echo number_format($net_income, 2); ?></h3><p>Ganancia Neta</p></div>
                <div class="summary-item"><h3 id="savingsRate"><?php echo number_format($savings_rate, 2); ?>%</h3><p>Porcentaje de Ahorro</p></div>
            </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (netIncomeElement && parseFloat(netIncomeElement.textContent.replace(/[^0-9.-]+/g,"")) < 0) { //
        setTimeout(() => {
            alert("⚠️ Atención: Estás gastando más de lo que ganas."); //
